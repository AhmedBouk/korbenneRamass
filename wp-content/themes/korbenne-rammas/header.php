...
<head>
    ...
    <script type="text/javascript" src="<?php echo get_template_directory_uri();?> /assets/js/sound.js"></script>
...
<div id="page" class="site">
	<header id="masthead" class="site-header">
		<nav class="navbar navbar-expand-md navbar-dark">
            ...
            <img class="logo" id="sidebarCollapse" onmouseover="/*play();*/" src="<?php echo get_template_directory_uri(); ?> /assets/img/Korbenne-ramass.png" width="260" height="130" onclick="displaySidebar()">
